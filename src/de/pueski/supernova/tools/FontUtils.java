...
public class FontUtils {
	...
	public static final int drawString(Font font, final String s, final Alignment alignment, final int x, final int y, final int width, Color color) {
	 ...
	 * 
	 * @param g
	 *            The non-null {@link Graphics2D} instance to use to draw the
	 *            given {@link String}.
	 * @param s
	 ...
	 *             arguments are null.
	 */
	private static int drawJustifiedSpaceSeparatedSubstrings(Font font, final String s, final int x, final int y, final int justifiedSpaceWidth) {
		int curpos = 0;
		int endpos = 0;
