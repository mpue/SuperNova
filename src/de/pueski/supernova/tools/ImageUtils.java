...
public class ImageUtils {
	...
	/**
	 * Creates a watermarked scoreText on a given {@link BufferedImage}
	 * 
	 * @param image the image to create the watermark on
	 * @param scoreText the scoreText to use as a watermark
	 * @param x the x position of the scoreText on the image
	 * @param y the y position of the scoreText on the image
